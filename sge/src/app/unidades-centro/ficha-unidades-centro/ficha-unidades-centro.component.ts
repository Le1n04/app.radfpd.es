...
@Component({
  selector: 'app-ficha-unidades-centro',
  templateUrl: './ficha-unidades-centro.component.html',
  styleUrls: ['./ficha-unidades-centro.component.scss']
})
export class FichaUnidadesCentroComponent implements OnInit {
